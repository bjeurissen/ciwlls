classdef T2_test < LogLinear
    ...
    methods (Access = public, Static = false)
        function obj = T2_test(te, varargin)
            fprintf(1, 'Setting up T2_test model ...\n');
            ...
            if exist('constr', 'var') && any(constr)
                ...
                if constr(3)
                    warning('Third constraint not implemented yet')
                end
            end
    ...
    methods (Access = public, Static = true)
        function metrics = metrics(x)
            fprintf(1, 'Calculating T2_test metrics ...\n');
