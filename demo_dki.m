...
[y,vox,v2w,grad] = MRtrix.readToMatlab('/Users/ben/Downloads/multib/dwi.mif');
...
mask = MRtrix.readToMatlab('/Users/ben/Downloads/multib/mask.mif'); % logical processing mask
mask (:,:,[1:10 12:end]) = false; % only process the 11-th slice
...
% visual inspection of DTI metrics
...
% write DTI metrics to MRtrix files
MRtrix.writeFromMatlab(m.b0 ,vox,v2w,[],'dti_b0.mif')
MRtrix.writeFromMatlab(m.ad ,vox,v2w,[],'dti_ad.mif')
MRtrix.writeFromMatlab(m.rd ,vox,v2w,[],'dti_rd.mif')
MRtrix.writeFromMatlab(m.md ,vox,v2w,[],'dti_md.mif')
MRtrix.writeFromMatlab(m.fa ,vox,v2w,[],'dti_fa.mif')
...
% visual inspection of DKI metrics
...
% write DKI metrics to MRtrix files
